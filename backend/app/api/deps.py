...
def get_agent_run_service(session: SessionDep) -> AgentRunService:
    return AgentRunService(session)


def get_investigation_service(session: SessionDep, settings: SettingsDep) -> InvestigationService:
    return InvestigationService(session, settings)
